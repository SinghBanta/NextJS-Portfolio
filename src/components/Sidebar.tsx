      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            exit={{ x: -200 }}
            className="px-6  z-[100] pt-10 pb-20 sm:pb-10 bg-neutral-100 w-48  fixed lg:relative  h-screen left-0 flex flex-col justify-between"
          >
  ...
  return (
    <div className="flex flex-col gap-2">
      <Image 
        ...
        className="object-cover object-top rounded-full flex-shrink-0 h-20 w-20 border-2"
      />
      <div className="flex text-sm flex-col">
        <p className="font-bold text-lg text-primary">Banta Singh</p>
